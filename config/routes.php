...
return static function (RouteBuilder $routes) {
    ...
    $routes->connect('/admin', ['controller' => 'Pages', 'action' => 'admin']);
    $routes->connect('/logout', ['controller' => 'Auth', 'action' => 'logout']);
    $routes->connect('/home', ['controller' => 'Pages', 'action' => 'home']);
    $routes->connect('/paymentOk', ['controller' => 'Orders', 'action' => 'paymentOk']);
    $routes->connect('/paymentFailed', ['controller' => 'Orders', 'action' => 'paymentFailed']);
